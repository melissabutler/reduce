...
with the keys as the vowel and the values as the number of times 
...
function vowelCount(str) {
    ...
    const lowercaseStr = str
            .toLowerCase()
            .split('');
    return lowercaseStr.reduce(function(newObj, currentValue){
...
value in the array and if the result of the callback function at that
 specific value is true, the value should be placed in the first subarray. 
